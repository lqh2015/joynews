package com.hzpd.custorm.switchbutton;
...
import com.hzpd.custorm.switchbutton.AnimationController.OnAnimateListener;
...
public class SwitchButton extends CompoundButton {
	...
	public SwitchButton(Context context, AttributeSet attrs, int defStyle) {
		...
		mConf.setRadius(ta.getInt(R.styleable.SwitchButton_custom_radius, Configuration.Default.DEFAULT_RADIUS));
