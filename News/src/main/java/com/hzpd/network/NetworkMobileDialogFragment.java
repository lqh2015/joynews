 ...
 * 本地更新,提示对话框
 */
public class NetworkMobileDialogFragment extends DialogFragment implements View.OnClickListener {


    public NetworkMobileDialogFragment() {
    }

    public static final String TAG = "NetworkMobileDialogFragment";
    public static boolean shown = false;
    public static NetworkMobileDialogFragment fragment;
    ...
    private void createContentView(Dialog dialog) {
        dialogView = LayoutInflater.from(getActivity()).inflate(
                R.layout.network_mobile_layout,
